...
UniValue getbalances(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "\nResult:\n"
            "total              (numeric) The total amount in PRCY received for this wallet.\n"
        	"spendable 			(numeric) The total amount in PRCY spendable for this wallet.\n"
        	"pending			(numeric) The total amount in PRCY pending for this wallet."
            "\nExamples:\n"
            "\nThe total amount in the server across all accounts\n" +
...
UniValue movecmd(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 5)
        throw runtime_error(
            ...
            "\nMove 0.01 PRCY timotei to akiko with a comment and funds have 6 confirmations\n" + HelpExampleCli("move", "\"timotei\" \"akiko\" 0.01 6 \"happy birthday!\"") +
