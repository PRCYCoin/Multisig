...
extern UniValue getpoablocktemplate(const UniValue& params, bool fHelp);
extern UniValue setminingnbits(const UniValue& params, bool fHelp);
...
extern UniValue getbalances(const UniValue& params, bool fHelp);
...
extern UniValue unlockwallet(const UniValue& params, bool fHelp);
